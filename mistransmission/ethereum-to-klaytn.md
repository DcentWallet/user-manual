# 카이아 주소로 오전송된 이더리움 기반 자산 복구하는 방법
...
아래 설명은 이더리움의 기반 자산인 오르빗체인(ORC)를 카이아의 (KORC) 주소로 오전송 하였을 때를 가정하여 작성되었습니다. 다른 이더리움 기반 자산을 카이아 주소로 오전송 하신 경우에도 같은 방식으로 진행하시면 됩니다.
...
먼저 오전송한 이더리움 기반 자산이 이더리움 블록체인에 존재하는지 확인합니다. 자산을 받은 주소인 카이아 주소를 이더리움 블록 익스플로러(이더스캔, [https://etherscan.io](https://etherscan.io))에서 조회하여 자산이 존재하는지 먼저 확인해야 합니다.

### **1단계 :** 카이아 계정 주소 복사

카이아 계정에서 ‘**받기**’ 버튼을 누르고 ‘**주소 복사**’를 눌러줍니다.

<figure><img src="../.gitbook/assets/17 (2).jpg" alt=""><figcaption></figcaption></figure>

### **2단계 :** 복사한 카이아 주소를 블록 익스플로러에서 검색

크롬 브라우저와 같은 인터넷 브라우저에서 이더스캔 사이트에 접속합니다.

* 이더스캔 : [https://etherscan.io](https://etherscan.io)

이더스캔 사이트에 접속후 1단계에서 복사한 카이아 주소를 검색합니다.
...
검색란에 **‘8217**을 입력하고 **“Ethereum(’8217)”**&#xB97C; 선택합니다. 카이아 주소를 가진 이더리움 계정을 만들기 위해 계정 주소는 “m/’44/‘8217/‘0/0/“0을 선택합니다.\
