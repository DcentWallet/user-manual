...
<figure><img src="../../.gitbook/assets/1 (3) (1).jpg" alt="" width="375"><figcaption></figcaption></figure>
...
## 펌웨어 업데이트 방법 <a href="#how-to-update-firmware" id="how-to-update-firmware"></a>

{% embed url="https://www.youtube.com/watch?v=yP-4rNniqio&feature=youtu.be" %}

### 펌웨어 업데이트를 위한 요구사항 <a href="#requirements-for-the-firmware-update" id="requirements-for-the-firmware-update"></a>
...
### 디센트 브릿지 프로그램 다운로드 <a href="#download-dcent-bridge-program" id="download-dcent-bridge-program"></a>
...
### 디센트 브릿지 프로그램 설치 (Windows) <a href="#install-dcent-bridge-program-windows" id="install-dcent-bridge-program-windows"></a>
...
### 디센트 브릿지 프로그램 설치 (Mac) <a href="#install-dcent-bridge-program-mac" id="install-dcent-bridge-program-mac"></a>
...
### 컴퓨터와 콜드월렛 연결 <a href="#connect-biometric-wallet-to-your-computer" id="connect-biometric-wallet-to-your-computer"></a>
...
### 펌웨어 버전 확인 <a href="#check-firmware-version" id="check-firmware-version"></a>
...
### 펌웨어 업데이트 완료 <a href="#completing-the-firmware-update" id="completing-the-firmware-update"></a>
...
<figure><img src="../../.gitbook/assets/2 (3) (1).jpg" alt="" width="375"><figcaption></figcaption></figure>
