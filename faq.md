...
## 내 지갑에 남아있는 20 개의 XRP를 양도 할 수없는 이유는 무엇입니까?

[Ripple의 정책](https://xrpl.org/reserves.html)은 새롭게 생성된 XRP 지갑 주소를 활성화된 상태로 변환하기 위해 20 XRP 이상의 Ripple을 XRP 지갑 주소로 양도 받아야합니다. XRP 지갑 주소의 활성화 비용은 20 XRP이며 이는 XRP 계정에 락업됩니다. 즉, 20XRP의 락업된 수은 XRP 계좌에서 인출 할 수 없습니다.
...
## 디센트 지갑에서 표시해주는 암호화폐 시세 값은 떤 거래소의 정보를 사용하나요? 

디센트는 [코인게코](https://www.coingecko.com/) 암호화 포탈 사이트의 암호화폐 시세 정보를 사용하여 지갑에서 표시해주고 있습니다. 코인게코는 전 세계 400개 이상의 거래소에서 6,000개 이상의 서로 다른 암호화폐 자산을 추적하는 데이터 어그리게이션 서비스를 운영하고 있습니다.
