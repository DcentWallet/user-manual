...
[Ripple의 정책](https://xrpl.org/reserves.html)은 새롭게 생성된 XRP 지갑 주소를 활성화된 상태로 변환하기 위해 20 XRP 이상의 Ripple을 XRP 지갑 주소로 양도 받아야합니다. XRP 지갑 주소의 활성화 비용은 20 XRP이며 이는 XRP 계정에 락업됩니다. 즉, 20XRP의 락업된 금액은 XRP 계좌에서 인출 할 수 없습니다.
