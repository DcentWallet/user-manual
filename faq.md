...
펌웨어 업데이트는 보통 5분 내외의 시간이 소요됩니다. 최대로 10분 가까이 걸릴 수 도 있습니다. 이 시간이 지났는데도 진척이 없다면 하드웨어의 상하좌우 4개 키 중 "아래 버튼" + "Power 버튼"을 동시에 눌러 강제 종료 후 다시 시도해 주시기 바랍니다.  자세한 대응 방법은 [여기](biometric-wallet/firmware-update/firmware-trouble-shooting-windows.md)에서 확인해 주시기 바랍니다.
