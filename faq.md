...
* 송금 후 잔액이 1 XRP 이상 남아 있어야 송금이 가능합니다.&#x20;
...
## 내 지갑에 남아있는 1개의 XRP를 양도 할 수없는 이유는 무엇입니까? <a href="#undefined" id="undefined"></a>
...
## 모바일 앱이나 PC용 소프트웨어 없이 하드웨어 디바이스만 사용해서 코인을 전송할 수 있나요? <a href="#undefined" id="undefined"></a>
