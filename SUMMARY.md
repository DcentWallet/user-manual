...
* [콜드월렛 복구하기](biometric-wallet/recovery/README.md)
...
* [멀티월렛 기능](mobile-app/multi-wallet-feature.md)
* [계정 만들기](mobile-app/create-account/README.md)
  ...
  * [커스텀 경로 BTC 계정 추가하는 방법](mobile-app/create-account/how-to-add-a-custom-path-btc-account.md)
...
* [다크모드 변경](mobile-app/undefined.md)
...
* [거래소 개인 지갑 인증 오류 시 확인해야 할 점](troubleshooting/check-points-on-email-verification-error.md)
...
* [오픈씨에 연결하기](external-service/how-to-connect-to-opensea.md)
