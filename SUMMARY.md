...
* [펌웨어 업데이트](biometric-wallet/firmware-update/README.md)
  * [트러블 슈팅 가이드 (Windows)](biometric-wallet/firmware-update/firmware-trouble-shooting-windows.md)
  * [트러블 슈팅 가이드 (Mac)](biometric-wallet/firmware-update/firmware-trouble-shooting-mac.md)
...
* [코인 보내기 사용법](coin-send-receive/send/README.md)
  * [지문인증형 콜드월렛 사용](coin-send-receive/send/mode\_biometric.md)
...
* [코인별 사용법](coin-send-receive/coins/README.md)
  ...
  * [리플 (XRP) 지갑 계정 사용법](coin-send-receive/coins/ripple-xrp/README.md)
    * [디센트 월렛으로 리플 (XRP) 보내기](coin-send-receive/coins/ripple-xrp/xrp\_send.md)
...
* [이메일 인증 오류시 확인해야 할 점](troubleshooting/undefined.md)
